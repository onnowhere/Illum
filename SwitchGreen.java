 ...
 */
public class SwitchGreen extends Animal
{
    public char id;
    public char color;
    public boolean on;
     ...
     */
    public SwitchGreen(char charid)
    { 
        GreenfootImage image = new GreenfootImage("GreenSwitchOff.png");
        image.scale(15,15);
        setImage(image);
        this.id = charid;
        this.color = 'g';
    ...
    public void setOff()
    {
        GreenfootImage imagex = new GreenfootImage("GreenSwitchOff.png");  
        imagex.scale(15,15);
        setImage(imagex);
        this.on = false;
    }
    public void setOn()
    {
        GreenfootImage imagex = new GreenfootImage("GreenSwitchOn.png");  
        imagex.scale(15,15);
        setImage(imagex);
        this.on = true;
    }
    ...
    {
        int timer = 0;
        if (this.id == '1') timer = 1000000;
        if (this.id == '2') timer = 50;
        if (this.id == '3') timer = 50;
        if (this.on == true)
        {
