...
/**
 * Write a description of class DarkLight here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class DarkLight extends Animal
{
    ...
    public DarkLight(int id)
    {
        this.id = id;
    }
    /**
     * Act - do whatever the DarkLight wants to do. This method is called whenever
    ...
    public void initial()
    {
        ...
        for (Object enemytemp : enemies)
        {
            enemy = (Enemy)enemytemp;
            if (enemy.id == this.id)
            {
                break;
            }
