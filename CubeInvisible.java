...
/**
 * Write a description of class CubeInvisible here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class CubeInvisible extends Animal
{
    public ArrayList<Line> lines = new ArrayList<Line>();
    public ArrayList<Vector> points = new ArrayList<Vector>();
    /**
     * Act - do whatever the CubeInvisible wants to do. This method is called whenever
     * the 'Act' or 'Run' button gets pressed in the environment.
     */
    public CubeInvisible()
    {
